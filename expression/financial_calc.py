...
# calculatio percent of transportation (transportation/income) (variable)
...
print(f"You spend ${rent} on rent, which is {rent_percent:.2}% of your income")
...
print(f"You save ${saving} each month, which is {saving_percent:.2f}% of your income")
# tell user category spending amount AND percent for spending  100 ("you spend $xx% on spending that is xx% of your income")
print(f"You have ${spending}remaining for other spending, which is {spending_percent:.2f}% of your income") 